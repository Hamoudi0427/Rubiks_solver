...
std::string rotateUpClockwise(const std::string& cube)
{
    ...
    std::vector<std::vector<int>> src_dst = { {0, 2}, {1, 5}, {2, 8}, {3, 1}, {5, 7}, {6, 0}, {7, 3}, {8, 6}, {18, 36}, {19, 37}, {20, 38}, {9, 18}, {10, 19}, {11, 20},
    {45, 9}, {46, 10}, {47, 11}, {36, 45}, {37, 46}, {38, 47} };

    //apply the rotation
    std::string new_cube = cube;
    for (std::vector<int> perm : src_dst)
    {
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {2, 0}, {5, 1}, {8, 2}, {1, 3}, {7, 5}, {0, 6}, {3, 7}, {6, 8}, {36, 18}, {37, 19}, {38, 20}, {18, 9}, {19, 10}, {20, 11},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {18, 20}, {19, 23}, {20, 26}, {21, 19}, {23, 25}, {24, 18}, {25, 21}, {26, 24}, {6, 9}, {7, 12}, {8, 15}, {9, 29},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {20, 18}, {23, 19}, {26, 20}, {19, 21}, {25, 23}, {18, 24}, {21, 25}, {24, 26}, {9, 6}, {12, 7}, {15, 8}, {29, 9},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {36, 38}, {37, 41}, {38, 44}, {39, 37}, {41, 43}, {42, 36}, {43, 39}, {44, 42}, {0, 18}, {3, 21}, {6, 24}, {18, 27},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {38, 36}, {41, 37}, {44, 38}, {37, 39}, {43, 41}, {36, 42}, {39, 43}, {42, 44}, {18, 0}, {21, 3}, {24, 6}, {27, 18},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {9, 11}, {10, 14}, {11, 17}, {12, 10}, {14, 16}, {15, 9}, {16, 12}, {17, 15}, {20, 2}, {23, 5}, {26, 8}, {2, 51},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {11, 9}, {14, 10}, {17, 11}, {10, 12}, {16, 14}, {9, 15}, {12, 16}, {15, 17}, {2, 20}, {5, 23}, {8, 26}, {51, 2},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {45, 47}, {46, 50}, {47, 53}, {48, 46}, {50, 52}, {51, 45}, {52, 48}, {53, 51}, {11, 0}, {14, 1}, {17, 2}, {0, 42},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {47, 45}, {50, 46}, {53, 47}, {46, 48}, {52, 50}, {45, 51}, {48, 52}, {51, 53}, {0, 11}, {1, 14}, {2, 17}, {42, 0},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {27, 29}, {28, 32}, {29, 35}, {30, 28}, {32, 34}, {33, 27}, {34, 30}, {35, 33}, {24, 15}, {25, 16}, {26, 17}, {15, 51},
...
{
    //define the rotation as a set of permutations
    std::vector<std::vector<int>> src_dst = { {29, 27}, {32, 28}, {35, 29}, {28, 30}, {34, 32}, {27, 33}, {30, 34}, {33, 35}, {15, 24}, {16, 25}, {17, 26}, {51, 15},
