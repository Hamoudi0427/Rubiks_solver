...
# To-Do
1) Clean/Refactor Code.
2) Improve color detection through color distance (as opposed to preset color ranges).
3) Improve UI (during solve).
4) Multi-threading during solve to hide small runtime delay.
